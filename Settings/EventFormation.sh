...
g_TTE_INPUT_COMMAND="differential-threshold-discriminator --threshold ${g_TTE_FTD_THRESHOLD} --duration ${g_TTE_FTD_DURATION} --cool-off ${g_TTE_FTD_COOLOFF}"